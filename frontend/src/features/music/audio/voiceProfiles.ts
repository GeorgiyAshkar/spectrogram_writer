...
const KEYS_PROFILE = profile('sine', 0.92, 0.080, 0.12, 0.843, MEASURED_INSTRUMENT_PARTIALS.keys, 0.271);
const PLUCK_PROFILE = profile('sine', 0.86, 0.082, 0.08, 0.841, MEASURED_INSTRUMENT_PARTIALS.pluck, 0.263);
const BELL_PROFILE = profile('sine', 0.74, 0.078, 0.42, 0.753, MEASURED_INSTRUMENT_PARTIALS.bell, 1.129);
const MARIMBA_PROFILE = profile('sine', 0.78, 0.079, 0.16, 0.801, MEASURED_INSTRUMENT_PARTIALS.marimba, 0.221);
...
const CHIME_PROFILE = profile('sine', 0.66, 0.083, 0.5, 0.770, MEASURED_INSTRUMENT_PARTIALS.chime, 1.241);

    ...
    <div className="app-shell">
      ...
      <main className="layout-grid">
        <div className="layout-grid__main">
          <SettingsSection title="Текст и тайминг" description="Основные параметры сообщения и длительности сигнала.">
          ...
          <SettingsSection title="Параметры генерации" description="Все остальные настройки собраны в компактную сетку без лишней прокрутки.">
            <div className="fields-grid fields-grid--compact">
              ...
              <FormField label="Высота bitmap" hint="Количество частотных линий."><input type="number" value={formData.img_height} onChange={(e) => updateField('img_height', Number(e.target.value))} /></FormField>
        ...
        <aside className="layout-grid__sidebar">
          <section className="panel action-card panel--compact">
            <h2>Результат</h2>
            <p className="action-card__text">Предпросмотр обновляется автоматически. Если результат подходит, скачайте WAV.</p>
